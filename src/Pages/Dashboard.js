...
class Dashboard extends Component {
  ...
  async loadWeb3() {
    if (window.ethereum) {
      ...
      window.web3 = new Web3.providers.HttpProvider("http://127.0.0.1:7545")
    }
    else {
  ...
  render() {
    ...
    const authorizedAccounts = ['0x9568bA841075Ee4eaa679ab565509B017e3e8d11'.toLowerCase()]
    const authorizedAccounts2 = ['0xaE6DdaD6c5f845e3e0d04E40F69b69066c613b0b'.toLowerCase()]
