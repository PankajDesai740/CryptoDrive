          ...
          <div className="body-form">
           ...
           {error && <Alert variant="danger">{error}</Alert>}
            ...
            <div className="input-group mb-3">
              <input type="text" className="form-control" placeholder="Email" ref={emailRef} id="email"/>
              <span className="input-group-text" id="basic-addon2">@drivercryptridez.com</span>
            </div>
